...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nouvelle Œuvre</a>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$row['prenom_artisan'].' '.$row['nom_artisan']."</td>
  ...
  <?php include 'includes/oeuvres_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#view_artisan').text(response.prenom_artisan + ' ' + response.nom_artisan);
